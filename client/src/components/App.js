  ...
  constructor() {
    ...
    this.state = {
      ...
      channels: [
        ...
        {
          //Channel 6
          header: 'Inside Dental Assisting',
          headerLink: '',
          title1: '',
          subhead1: '',
          link1: '',
        ...
        },
        {
          //Channel 9
          header: 'Live Events',
          headerLink: 'https://cdeworld.com/regional-events',
          title1: '',
          subhead1: '',
          link1: '',
          img: '',
    ...
    return (
      <div className="App">
        <header className="App-header">
          {/* <img src="https://www.aegisdentalnetwork.com/img/layout/general/da-logo-large.png" width="300" /> */}
          <h1 className="App-title">Aegis Dental Network<br />Homepage Updater</h1>
        </header>
